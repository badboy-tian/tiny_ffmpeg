...
#define FFMPEG_CONFIGURATION "--prefix=/data/ohos/tpc_c_cplusplus/lycium/usr/FFmpeg/arm64-v8a/ --enable-small --enable-runtime-cpudetect --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --disable-network --disable-programs --enable-ohcodec --disable-encoders --enable-libx264 --enable-libmp3lame --enable-gpl --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=mpeg1video --enable-encoder=mp2 --enable-encoder=mjpeg --enable-encoder=png --enable-encoder=pcm_s16le --enable-encoder=wav --enable-encoder=libx264 --enable-encoder=libmp3lame --enable-encoder=h264_ohcodec --enable-encoder=hevc_ohcodec --disable-decoders --enable-decoder=mpeg4 --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=h264_ohcodec --enable-decoder=hevc_ohcodec --enable-decoder=mp3float --enable-decoder=mpeg1video --enable-decoder=mp2float --enable-decoder=mjpeg --enable-decoder=png --enable-decoder=pcm_s16le --enable-decoder=pcm_u8 --enable-decoder=wav --disable-muxers --enable-muxer=mpegts --enable-muxer=mpeg1system --enable-muxer=flv --enable-muxer=avi --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=adts --enable-muxer=mp3 --enable-muxer=ac3 --enable-muxer=image2 --enable-muxer=matroska --enable-muxer=wav --enable-muxer=concat --enable-muxer=mov --disable-demuxers --enable-demuxer=mpegts --enable-demuxer=mpegps --enable-demuxer=mpegvideo --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ac3 --enable-demuxer=image2 --enable-demuxer=matroska --enable-demuxer=wav --enable-demuxer=concat --enable-demuxer=mov --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=hevc --enable-parser=mpegvideo --enable-parser=mpegaudio --enable-parser=mpeg4video --enable-parser=ac3 --enable-parser=mp3 --enable-parser=mov --enable-parser=mjpeg --enable-parser=png --disable-filters --enable-filter=aformat --enable-filter=aresample --enable-filter=volume --enable-filter=scale --enable-filter=aloop --enable-filter=loop --enable-filter=adelay --enable-filter=amix --enable-filter=transpose --enable-filter=acrossfade --enable-filter=crop --enable-filter=atempo --enable-filter=reverse --enable-filter=areverse --enable-filter=setpts --enable-filter=concat --enable-filter=anullsrc --enable-filter=pan --enable-filter=pad --enable-filter=apad --enable-filter=anull --enable-filter=asetpts --enable-filter=asetnsamples --enable-filter=amerge --enable-filter=atrim --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=extract_extradata --enable-hwaccels --enable-hwaccel=h264_ohcodec --enable-hwaccel=hevc_ohcodec --disable-protocols --enable-protocol=file --enable-protocol=http --enable-protocol=https --enable-neon --enable-asm --enable-cross-compile --enable-pic --enable-static --enable-shared --extra-cflags='-I/data/ohos/tpc_c_cplusplus/lycium/usr/x264/arm64-v8a/include -I/data/ohos/tpc_c_cplusplus/lycium/usr/lame/arm64-v8a/include' --extra-ldflags='-L/data/ohos/tpc_c_cplusplus/lycium/usr/x264/arm64-v8a/lib -lx264 -L/data/ohos/tpc_c_cplusplus/lycium/usr/lame/arm64-v8a/lib -lmp3lame' --target-os=linux --arch=aarch64 --cc=/data/ohos/ohos_sdk/native/llvm/bin/aarch64-linux-ohos-clang --ld=/data/ohos/ohos_sdk/native/llvm/bin/aarch64-linux-ohos-clang --strip=/data/ohos/ohos_sdk/native/llvm/bin/llvm-strip --host-cc=/data/ohos/ohos_sdk/native/llvm/bin/aarch64-linux-ohos-clang --host-ld=/data/ohos/ohos_sdk/native/llvm/bin/aarch64-linux-ohos-clang --host-os=linux --host-ldflags=-L/data/ohos/ohos_sdk/native/sysroot/usr/lib/aarch64-linux-ohos --sysroot=/data/ohos/ohos_sdk/native/sysroot"
...
#define CC_IDENT "OHOS (dev) clang version 15.0.4 (llvm-project d1aa604d90b55a96aa22af9992d170fccbd41938)"
