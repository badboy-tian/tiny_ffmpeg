...
#define FFMPEG_CONFIGURATION "--prefix=/data/ohos/tpc_c_cplusplus/lycium/usr/FFmpeg/arm64-v8a --enable-small --enable-runtime-cpudetect --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-network --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-postproc --enable-avresample --disable-hwaccels --disable-encoders --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=mpeg1video --enable-encoder=mp2 --enable-encoder=mjpeg --enable-encoder=png --enable-encoder=pcm_s16le --enable-encoder=wav --enable-encoder=libmp3lame --disable-decoders --enable-decoder=mpeg4 --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=h264 --enable-decoder=hevc --enable-decoder=mp3float --enable-decoder=mpeg1video --enable-decoder=mp2float --enable-decoder=mjpeg --enable-decoder=png --enable-decoder=pcm_s16le --enable-decoder=wav --disable-muxers --enable-muxer=mpegts --enable-muxer=mpeg1system --enable-muxer=flv --enable-muxer=avi --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=adts --enable-muxer=mp3 --enable-muxer=ac3 --enable-muxer=image2 --enable-muxer=matroska --enable-muxer=wav --disable-demuxers --enable-demuxer=mpegts --enable-demuxer=mpegps --enable-demuxer=mpegvideo --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=hevc --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ac3 --enable-demuxer=image2 --enable-demuxer=matroska --enable-demuxer=wav --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=hevc --enable-parser=mpegvideo --disable-filters --enable-filter=aformat --enable-filter=aresample --enable-filter=volume --enable-filter=scale --enable-filter=aloop --enable-filter=loop --enable-filter=adelay --enable-filter=amix --enable-filter=transpose --enable-filter=acrossfade --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=extract_extradata --disable-protocols --enable-protocol=file --enable-protocol=http --enable-gpl --enable-nonfree --enable-libmp3lame --enable-libfdk-aac --enable-libx264 --enable-neon --enable-asm --enable-cross-compile --enable-pic --disable-librtmp --enable-static --disable-shared --target-os=linux --arch=aarch64 --cc=/data/ohos/ohos-sdk/linux/native/llvm/bin/aarch64-linux-ohos-clang --ld=/data/ohos/ohos-sdk/linux/native/llvm/bin/aarch64-linux-ohos-clang --strip=/data/ohos/ohos-sdk/linux/native/llvm/bin/llvm-strip --host-cc=/data/ohos/ohos-sdk/linux/native/llvm/bin/aarch64-linux-ohos-clang --host-ld=/data/ohos/ohos-sdk/linux/native/llvm/bin/aarch64-linux-ohos-clang --host-os=linux --extra-cflags='-I/data/ohos/tpc_c_cplusplus/lycium/usr/lame/arm64-v8a/include -I/data/ohos/tpc_c_cplusplus/lycium/usr/fdk-aac/arm64-v8a/include -I/data/ohos/tpc_c_cplusplus/lycium/usr/x264/arm64-v8a/include' --extra-ldflags='-L/data/ohos/tpc_c_cplusplus/lycium/usr/lame/arm64-v8a/lib -L/data/ohos/tpc_c_cplusplus/lycium/usr/fdk-aac/arm64-v8a/lib -L/data/ohos/tpc_c_cplusplus/lycium/usr/x264/arm64-v8a/lib' --host-ldflags=-L/data/ohos/ohos-sdk/linux/native/sysroot/usr/lib/aarch64-linux-ohos --sysroot=/data/ohos/ohos-sdk/linux/native/sysroot"
