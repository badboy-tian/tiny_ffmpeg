...
// Stub resource data - empty strings for CSS and HTML templates
// In a full FFmpeg build, these would be generated from actual resource files
static const unsigned char ff_graph_html_data[] = "";
static const unsigned int ff_graph_html_len = 0;

static const unsigned char ff_graph_css_data[] = "";
static const unsigned int ff_graph_css_len = 0;
