...
#define FFMPEG_CONFIGURATION "--enable-small --enable-runtime-cpudetect --disable-debug --disable-doc --disable-htmlpages --disable-manpages --disable-podpages --disable-txtpages --enable-avdevice --enable-avcodec --enable-avformat --enable-avutil --enable-swresample --enable-swscale --enable-avfilter --enable-postproc --enable-avresample --disable-network --disable-hwaccels --disable-encoders --enable-encoder=mpeg4 --enable-encoder=aac --enable-encoder=ac3 --enable-encoder=mpeg1video --enable-encoder=mp2 --enable-encoder=mjpeg --enable-encoder=png --disable-decoders --enable-decoder=mpeg4 --enable-decoder=aac --enable-decoder=ac3 --enable-decoder=h264 --enable-decoder=mp3float --enable-decoder=mpeg1video --enable-decoder=mp2float --enable-decoder=mjpeg --enable-decoder=png --disable-muxers --enable-muxer=mpegts --enable-muxer=mpeg1system --enable-muxer=flv --enable-muxer=avi --enable-muxer=mp4 --enable-muxer=h264 --enable-muxer=adts --enable-muxer=mp3 --enable-muxer=ac3 --enable-muxer=image2 --enable-muxer=matroska --disable-demuxers --enable-demuxer=mpegts --enable-demuxer=mpegps --enable-demuxer=mpegvideo --enable-demuxer=flv --enable-demuxer=avi --enable-demuxer=mov --enable-demuxer=h264 --enable-demuxer=aac --enable-demuxer=mp3 --enable-demuxer=ac3 --enable-demuxer=image2 --enable-demuxer=matroska --disable-parsers --enable-parser=aac --enable-parser=aac_latm --enable-parser=h264 --enable-parser=mpegvideo --disable-filters --enable-filter=aformat --enable-filter=aresample --enable-filter=volume --enable-filter=scale --enable-filter=aloop --enable-filter=loop --enable-filter=adelay --enable-filter=amix --enable-filter=transpose --enable-filter=acrossfade --disable-bsfs --enable-bsf=aac_adtstoasc --enable-bsf=h264_mp4toannexb --enable-bsf=extract_extradata --disable-protocols --enable-protocol=file --enable-cross-compile --enable-pic --enable-static --disable-shared --target-os=android --enable-jni --enable-optimizations --disable-debug --enable-small --enable-mediacodec --enable-decoder=h264_mediacodec --enable-gpl --enable-libx264 --enable-encoder=libx264 --enable-nonfree --enable-libfdk-aac --enable-encoder=libfdk_aac --enable-libmp3lame --enable-encoder=libmp3lame --cross-prefix=/Users/tian/Downloads/work/NDK21/NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android- --sysroot= --prefix=/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/ffmpeg --pkg-config=/usr/local/bin/pkg-config --arch=aarch64 --cpu=armv8-a --ar=/Users/tian/Downloads/work/NDK21/NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android-ar --cc=/Users/tian/Downloads/work/NDK21/NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang --cxx=/Users/tian/Downloads/work/NDK21/NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android21-clang++ --as= --ranlib=/Users/tian/Downloads/work/NDK21/NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android-ranlib --strip=/Users/tian/Downloads/work/NDK21/NDK/toolchains/llvm/prebuilt/darwin-x86_64/bin/aarch64-linux-android-strip --extra-cflags=' -O3 -Wall -pipe -std=c99 -ffast-math -fstrict-aliasing -Werror=strict-aliasing -Wa,--noexecstack -DANDROID -DNDEBUG -D__ANDROID_API__=21 -I/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/x264/include -I/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/fdk-aac/include -I/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/mp3lame/include' --extra-ldflags=' -L/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/x264/lib -lx264 -lm -ldl -L/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/fdk-aac/lib -lfdk-aac -lm -L/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/mp3lame/lib -lmp3lame' --enable-neon --enable-asm --enable-inline-asm --ln_s='cp -rf'"
#define FFMPEG_LICENSE "nonfree and unredistributable"
#define CONFIG_THIS_YEAR 2019
#define FFMPEG_DATADIR "/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/Users/tian/Downloads/work/ffmpeg-build-scripts/build/android-arm64/ffmpeg/share/ffmpeg"
